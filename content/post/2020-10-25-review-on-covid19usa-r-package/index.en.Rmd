...
author: Aarathy Babu
date: '2020-10-25'
slug: review-on-covid19usa-r-package
categories: []
tags: []
subtitle: ''
summary: ''
...
![Snapshot from the enclosed Shiny App depicting the Impact of COVID-19 over time](/2020-10-25-review-on-covid19usa-r-package/index.en_files/ltmoo2.png)

### Other features of the package

The package includes four functions which according to the vignette and README file ,was created by the author to improve the logic of the web application enclosed in the package. 
...
I would say the primary lesson that I have learned after taking a look at the author's package is how an app as well as a package can be made precise, well laid out and thoughtful. I enjoyed a lot navigating through the package as well as the app enclosed within. The linkage between the map and line plot was an interesting touch as well.

Another lesson I have learnt is the importance of the documentation in a package. Without a well detailed documentation like this, I am sure I would have been lost on what each function does in the package.
